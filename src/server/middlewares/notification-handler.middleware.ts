...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Vehicle Addition.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'operations-staff', 'business-owner'],
    key: 'vehicle_addition',
    tenantPath: [],
    userPath: [],
  },
  'Booking Creation.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'operations-staff', 'business-owner', 'car-manager'],
    key: 'booking_creation',
    tenantPath: [],
    userPath: [],
  },
  'Vehicle Servicing.update': {
    roles: ['owner', 'fleet-manager', 'admin', 'business-owner', 'car-manager'],
